...
InputData Input::getInput()
{
    ...
    static InputData data{  .sunPos{ -10.,30.,260. }, .sunColor{ 1.0,1.0,0.5 }, .sunCoronaStrength = 30.0,
                            ...
                            .atmosRadius = 18., .atmosFalloff = 18., .atmosScattering = 1., .atmosColorPower = 400., .atmosColor{700., 530., 440.},
    ...
    ImGui::SliderFloat("atmos color power", &data.atmosColorPower, 100., 800.);
